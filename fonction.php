...
function afficherMatch(){
    $matchs = array(
        ...
        array("equipe1" => "Lyon", "equipe2" => "Marseille", "date" => "2026-10-02","image" => "images/match_2.jpeg"),
        array("equipe1" => "Monaco", "equipe2" => "Nice", "date" => "2026-10-03","image" => "images/match_3.jpeg")
    );
    ...
    foreach ($matchs as $match) {
        ...
        echo "<a href='index.php?page=match&equipe1=" . urlencode($match['equipe1']) . "&equipe2=" . urlencode($match['equipe2']) . "&date=" . urlencode($match['date']) . "'>";
